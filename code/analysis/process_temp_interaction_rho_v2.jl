...
############## collecting results ##############
path_1 = glob("Eff_iters0_ρ1_*", "../data/20250917/p05_test_input/")
...
path_2 = glob("Eff_iters0_ρ2_*", "../data/20250903/p05_test_input/")
...
path_3 = glob("Eff_iters0_ρ3_*", "../data/20250903/p05_test_input/")
...
path_4 = glob("Eff_iters0_ρ4_*", "../data/20250911/p05_test_input/")
...
@save "../data/20250911/p05_test_input/summary_temp_inter_rho.jld2" all_rich_collect_1 all_ii_collect_1 all_ij_collect_1 all_rich_collect_2 all_ii_collect_2 all_ij_collect_2 all_rich_collect_3 all_ii_collect_3 all_ij_collect_3 all_rich_collect_4 all_ii_collect_4 all_ij_collect_4
# @load "../data/20250903/p05_test_input/summary_temp_inter_rho.jld2" all_rich_collect_1 all_ii_collect_1 all_ij_collect_1 all_rich_collect_2 all_ii_collect_2 all_ij_collect_2 all_rich_collect_3 all_ii_collect_3 all_ij_collect_3 all_rich_collect_4 all_ii_collect_4 all_ij_collect_4
...
path_2 = glob("Eff_iters0_ρ2_*", "../data/20250917/p05_test_input/")
progress = Progress(length(path_2)*num_temps; desc="Progress running:")
...
path_3 = glob("Eff_iters0_ρ3_*", "../data/20250917/p05_test_input/")
progress = Progress(length(path_3)*num_temps; desc="Progress running:")
...
path_4 = glob("Eff_iters0_ρ4_*", "../data/20250917/p05_test_input/")
progress = Progress(length(path_4)*num_temps; desc="Progress running:")
...
sta_4 = [sum(real.(all_leading_collect_4[t]) .< 0)/length(path_4) for t in 1:num_temps]

@save "../data/20250917/p05_test_input/summary_stability_rho.jld2" all_leading_collect_1 all_leading_collect_2 all_leading_collect_3 all_leading_collect_4 dℵij_collect_1 dℵij_collect_2 dℵij_collect_3 dℵij_collect_4
